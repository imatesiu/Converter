...
//
void Utility::setbit(unsigned int buf[], int offset) {
	//
	// estrai il Byte da modifcare
	//
	int masks[] = {128,64,32,16,8,4,2,1}; // le maschere per settare i bit
...
//
void Utility::push (unsigned int buf[], unsigned int data, int len, int off) {
	//
...
unsigned int Utility::toint(unsigned int C) {
	int res =0;
...
//
int Utility::getbit(unsigned int buf[], int offset) {
	//
	// estrai il Byte da leggere
	//
	int masks[] = {0x80,64,32,16,8,4,2,1}; // le maschere per settare i bit
...
//
unsigned int Utility::pop (unsigned int buf[], int len, int off) {
	//
